...
class MainActivity() : AppCompatActivity() {
    ...
    private fun startWithPermissionCheck() {
        ...
        val bpmUpdates = HeartRateOmeter()
                ...
                .subscribe({
                    ...
                    m.set(0, 0, it.HeartRate.toDouble())
                    ...
                    val bpm = it.copy(HeartRate = c.get(0, 0).toInt())
                    Log.v("HeartRateOmeter", "[onBpm] ${it.HeartRate} => ${bpm.HeartRate}")
                    onBpm(bpm)
    ...
    private fun onBpm(bpm: HeartRateOmeter.Bpm) {
        ...
        label.text = "Your Heart Rate is " +bpm.HeartRate + " bpm"
    }
